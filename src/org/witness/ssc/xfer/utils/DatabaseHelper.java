...
public class DatabaseHelper extends SQLiteOpenHelper {
	...
	public void onCreate(SQLiteDatabase db) {
		...
		db.insert(FILENAME_TABLE_NAME, FilenameDetails.NEXT_FILENAME_NUMBER,
				vals);

		db.execSQL("CREATE TABLE " + SDFILERECORD_TABLE_NAME + " ("
				+ SDFileRecord._ID + " INTEGER PRIMARY KEY,"
				+ SDFileRecord.FILENAME + " TEXT," + SDFileRecord.FILEPATH
				+ " TEXT," + SDFileRecord.LENGTH_SECS + " INTEGER,"
				+ SDFileRecord.CREATED_DATETIME + " INTEGER,"
				+ SDFileRecord.VIDEO_AUDIO_CODEC_STRING + " TEXT,"
				+ SDFileRecord.TITLE + " TEXT," + SDFileRecord.DESCRIPTION
				+ " TEXT" + " );");

		db.execSQL("CREATE TABLE " + HOST_TABLE_NAME + " (" + HostDetails._ID
				+ " INTEGER PRIMARY KEY," + HostDetails.HOST_URI + " TEXT,"
	...
	public static final class SDFileRecord implements BaseColumns {
		...
		public static final Uri CONTENT_URI = Uri.parse("content://"
				+ AUTHORITY + "/" + SDFILERECORD_TABLE_NAME);

		// The MIME type providing a directory of appstats.
		public static final String CONTENT_TYPE = CONTENT_TYPE_BASE + "."
				+ SDFILERECORD_TABLE_NAME;

		// The MIME type providing a sub-directory of a single note.
		public static final String CONTENT_ITEM_TYPE = CONTENT_ITEM_TYPE_BASE
				+ "." + SDFILERECORD_TABLE_NAME;
